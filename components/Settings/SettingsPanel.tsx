...
export function SettingsPanel({ open, onClose, anchorRef }: Props) {
  ...
  return (
    <div
      ref={panelRef}
      className="absolute right-0 top-full mt-1 z-50 w-64 bg-surface rounded-xl border border-line-strong shadow-lg dark:shadow-panel p-4 flex flex-col gap-4"
    >
      <div className="flex items-center justify-between">
        <span className="text-[11px] font-bold text-content-tertiary uppercase tracking-wider">
          Configurações
        </span>
        <button
