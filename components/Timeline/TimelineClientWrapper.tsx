      ...
      <div className="shrink-0 flex flex-wrap items-center gap-2 px-3 py-2 border-b border-line bg-surface">
        ...
        <div className="relative">
          <button
            ...
            className={`w-7 h-7 flex items-center justify-center rounded-full transition-colors ${settingsOpen ? "bg-brand-bg text-brand dark:shadow-brand-glow" : "text-gray-400 hover:text-gray-700 dark:text-[#8896a8] dark:hover:text-[#b7ff00] hover:bg-surface-hover"
              }`}
            title="Configurações"
          >
